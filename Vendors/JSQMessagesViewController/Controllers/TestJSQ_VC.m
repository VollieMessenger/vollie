...
@interface TestJSQ_VC () <JSQMessagesInputToolbarDelegate,
...
@implementation TestJSQ_VC

#pragma mark - Class methods

+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([TestJSQ_VC class])
                          bundle:[NSBundle bundleForClass:[TestJSQ_VC class]]];
}

+ (instancetype)messagesViewController
{
    return [[[self class] alloc] initWithNibName:NSStringFromClass([TestJSQ_VC class])
                                          bundle:[NSBundle bundleForClass:[TestJSQ_VC class]]];
}
