...
@interface CardChatVC ()<JSQMessagesInputToolbarDelegate, JSQMessagesKeyboardControllerDelegate>
...
@implementation CardChatVC

+ (UINib *)nib
{
    return [UINib nibWithNibName:NSStringFromClass([CardChatVC class])
                          bundle:[NSBundle mainBundle]];
}

+ (instancetype)messagesViewController
{
    return [[[self class] alloc] initWithNibName:NSStringFromClass([CardChatVC class])
                                          bundle:[NSBundle mainBundle]];
}
