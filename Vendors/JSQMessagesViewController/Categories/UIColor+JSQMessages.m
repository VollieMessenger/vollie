...
{
//81 180 165 OLD
    return [UIColor colorWithRed:109/255.0f green:200/255.0f blue:192/255.0f alpha:1.0f];
}

+ (UIColor *)volleyFamousOrange
{
//232 113 67 OLD
    return [UIColor colorWithRed:246/255.0f green:140/255.0f blue:69/255.0f alpha:1.0f];
}
...
{
    return [UIColor colorWithRed:65/255.0f
                           green:65/255.0f
                            blue:65/255.0f
                           alpha:1];
}
...
{
    return [UIColor colorWithRed:232/255.0f
                           green:232/255.0f
                            blue:232/255.0f
                           alpha:1];
}
...
+ (NSArray *)arrayOfColorsCore {
    return [NSArray arrayWithObjects:[UIColor volleyBubbleGreen],
            [UIColor volleyFlatOrange], [UIColor volleyFlatGreen],[UIColor volleyFlatPeach],[UIColor volleyMustardYellow], nil];
}
