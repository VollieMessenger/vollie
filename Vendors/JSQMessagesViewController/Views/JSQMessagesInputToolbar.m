...
- (void)toggleSendButtonOnAlways
{
    if (self.sendButtonOnRight) {
        self.contentView.rightBarButtonItem.enabled = !self.contentView.rightBarButtonItem.isEnabled;
    }
    else {
        self.contentView.leftBarButtonItem.enabled = !self.contentView.leftBarButtonItem.isEnabled;
    }
}
