...
//  self.cellTopLabel.font = [UIFont boldSystemFontOfSize:14.0f];
    self.cellTopLabel.textColor = [UIColor darkGrayColor]; //TIME
   self.messageBubbleTopLabel.textColor = [UIColor groupTableViewBackgroundColor];
...
//    self.messageBubbleTopLabel.font = [UIFont systemFontOfSize:12.0f];
    ...
    self.cellBottomLabel.textColor = [UIColor whiteColor];
...
-(void)setMessageBubbleIMageViewColor:(UIColor *)backgroundColor
{
