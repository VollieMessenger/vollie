...
//    _messageBubbleFont = [UIFont systemFontOfSize:16];
//    _messageBubbleFont = [UIFont fontWithName:@"ArialBoundedMTBold" size:15.0];
...
#warning EDIT from 2.0f
        ...
        CGFloat maximumTextWidth = self.itemWidth - avatarSize.width - self.messageBubbleLeftRightMargin - horizontalInsetsTotal + 50;
#warning PLUS 50
